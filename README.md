...
- **AIP** — Verifiable delegation for AI agents across MCP and A2A · [arXiv:2603.24775](https://arxiv.org/abs/2603.24775) · [`aip`](https://github.com/sunilp/aip)
- **Provenance Paradox** — Why self-reported agent quality harms routing · [arXiv:2603.18043](https://arxiv.org/abs/2603.18043) · [`ldp-research`](https://github.com/sunilp/ldp-research)
- **LDP** — Identity-aware protocol for multi-agent delegation · [arXiv:2603.08852](https://arxiv.org/abs/2603.08852) · [`ldp-protocol`](https://github.com/sunilp/ldp-protocol)
